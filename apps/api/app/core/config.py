...
class Settings(BaseSettings):
    ...
    rag_keyword_search_enabled: bool = True
    ...
    rag_parent_expand_enabled: bool = True
    rag_news_ttl_days: int = 30
    rag_staleness_labels_enabled: bool = True
    rag_news_today_cutoff_enabled: bool = True
    rag_news_today_max_age_days: int = 7
    rag_regime_index_enabled: bool = True
    rag_classifier_fallback_enabled: bool = True
    rag_query_cache_enabled: bool = True
    rag_query_cache_ttl_seconds: int = 300
    rag_query_cache_max_entries: int = 256
    rag_research_mode_enabled: bool = True
    rag_research_max_tool_rounds: int = 3
    rag_drift_check_enabled: bool = True
    rag_drift_alert_pct: float = 15.0
    rag_partial_indexes_enabled: bool = True
